...
public class TapjoyFeaturedAppWebView extends Activity
{
	...
	{	
		...
		webView = (WebView) findViewById(getApplicationContext().getResources().getIdentifier("FeaturedAppWebView", "id", clientPackage));
		...
		progressBar = (ProgressBar)findViewById(getResources().getIdentifier("FeaturedAppProgressBar", "id", clientPackage));
